...
#Rest command
    def rest():
        global heroHp
        if heroHp + 8 < maxHp: #if hero is has 8 or less hp than maxHp
            heroHp += (maxHp - heroHp) #he will heal the difference between current and maxHp
        elif heroHp < maxHp: #if hero has less than maxHp -9 hp
            print(Fore.WHITE + Style.BRIGHT + "\nYou are resting...")
            time.sleep(2)
            print(Fore.WHITE + Style.BRIGHT + "\n...")
            time.sleep(2)
